    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header bg-white">
          <i class="fa fa-align-justify"></i> Nuevo Per Juridica
        </div>
        <div class="card-body">
          <div class="col-12">

            <form action="{{  route('per-juridica-store') }}" method="POST" enctype="multipart/form-data">
              @csrf
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="pj_razon_social" id="pj_razon_social" placeholder="Razon Social">
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="pj_nombre_comercial" id="pj_nombre_comercial" placeholder="Nombre Comercial">
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="pj_glosa" id="pj_glosa" placeholder="Glosa">
                  </div>
                </div>

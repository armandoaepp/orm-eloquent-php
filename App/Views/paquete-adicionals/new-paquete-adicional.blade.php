    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header bg-white">
          <i class="fa fa-align-justify"></i> Nuevo Paquete Adicional
        </div>
        <div class="card-body">
          <div class="col-12">

            <form action="{{  route('paquete-adicional-store') }}" method="POST" enctype="multipart/form-data">
              @csrf
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="pa_precio" id="pa_precio" placeholder="Precio">
                  </div>
                </div>

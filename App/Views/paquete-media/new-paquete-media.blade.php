    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header bg-white">
          <i class="fa fa-align-justify"></i> Nuevo Paquete Media
        </div>
        <div class="card-body">
          <div class="col-12">

            <form action="{{  route('paquete-media-store') }}" method="POST" enctype="multipart/form-data">
              @csrf
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="pm_path_file" id="pm_path_file" placeholder="Path File">
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="pm_jerarquia" id="pm_jerarquia" placeholder="Jerarquia">
                  </div>
                </div>

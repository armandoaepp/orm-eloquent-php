    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header bg-white">
          <i class="fa fa-align-justify"></i> Nuevo Ubigeo
        </div>
        <div class="card-body">
          <div class="col-12">

            <form action="{{  route('ubigeo-store') }}" method="POST" enctype="multipart/form-data">
              @csrf
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="ubi_codigo" id="ubi_codigo" placeholder="Codigo">
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="ubi_ubigeo" id="ubi_ubigeo" placeholder="Ubigeo">
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="ubi_descripcion" id="ubi_descripcion" placeholder="Descripcion">
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="tipo_ubigeo_id" id="tipo_ubigeo_id" placeholder="Tipo Ubigeo Id">
                  </div>
                </div>

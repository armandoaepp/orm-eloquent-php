              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="persona_id" id="persona_id" placeholder="Persona Id" value="{{ $per_doc_identidad->persona_id }}" >
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="tipo_per_doc_identidad_id" id="tipo_per_doc_identidad_id" placeholder="Tipo Per Doc Identidad Id" value="{{ $per_doc_identidad->tipo_per_doc_identidad_id }}" >
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="pdi_fecha_emision" id="pdi_fecha_emision" placeholder="Fecha Emision" value="{{ $per_doc_identidad->pdi_fecha_emision }}" >
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="pdi_fecha_caducidad" id="pdi_fecha_caducidad" placeholder="Fecha Caducidad" value="{{ $per_doc_identidad->pdi_fecha_caducidad }}" >
                  </div>
                </div>

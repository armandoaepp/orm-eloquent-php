    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header bg-white">
          <i class="fa fa-align-justify"></i> Editar Paquete Actividad
        </div>
        <div class="card-body">
          <div class="col-12">

            <form action="{{  route('paquete-actividad-update') }}" method="POST" enctype="multipart/form-data">
              @csrf
              <input type="hidden" class="form-control" name="id" id="id" value="{{ $paquete_actividad->id }}">
              <div class="row">
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="pa_horas" id="pa_horas" placeholder="Horas" value="{{ $paquete_actividad->pa_horas }}" >
                  </div>
                </div>

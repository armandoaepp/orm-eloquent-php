              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="per_id_padre" id="per_id_padre" placeholder="Id Padre">
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="per_apellidos" id="per_apellidos" placeholder="Apellidos">
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="per_fecha_nac" id="per_fecha_nac" placeholder="Fecha Nac">
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="per_tipo" id="per_tipo" placeholder="Tipo">
                  </div>
                </div>

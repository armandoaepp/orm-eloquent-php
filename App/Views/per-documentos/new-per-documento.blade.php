    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header bg-white">
          <i class="fa fa-align-justify"></i> Nuevo Per Documento
        </div>
        <div class="card-body">
          <div class="col-12">

            <form action="{{  route('per-documento-store') }}" method="POST" enctype="multipart/form-data">
              @csrf
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="pd_numero" id="pd_numero" placeholder="Numero">
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="pd_descripcion" id="pd_descripcion" placeholder="Descripcion">
                  </div>
                </div>

                <div class="col-12 mb-3">
                  <div class="form-group">
                    <label for="pd_imagen">Imagen:</label>
                    <input data-file-img="images" data-id="preview-images-id" type="file" class="form-control" name="pd_imagen" id="pd_imagen" required placeholder="Imagen" accept="image/*">
                  </div>
                </div>

    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header bg-white">
          <i class="fa fa-align-justify"></i> Nuevo Rubro
        </div>
        <div class="card-body">
          <div class="col-12">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="rub_descripcion" id="rub_descripcion" placeholder="Descripcion">
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="rub_codigo" id="rub_codigo" placeholder="Codigo">
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="rub_glosa" id="rub_glosa" placeholder="Glosa">
                  </div>
                </div>

    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header bg-white">
          <i class="fa fa-align-justify"></i> Nuevo Per Imagen
        </div>
        <div class="card-body">
          <div class="col-12">

            <form action="{{  route('per-imagen-store') }}" method="POST" enctype="multipart/form-data">
              @csrf
              ...
              <div class="row">
                ...
                <div class="col-12 mb-3">
                  <div class="form-group">
                    <label for="pi_imagen">Imagen:</label>
                    <input data-file-img="images" data-id="preview-images-id" type="file" class="form-control" name="pi_imagen" id="pi_imagen" required placeholder="Imagen" accept="image/*">
                  </div>
                </div>

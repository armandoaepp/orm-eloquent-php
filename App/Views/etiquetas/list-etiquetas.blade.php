            ...
            ?>
              ...
              <tr class="<?php echo $class_estado; ?>">
                ...
                <td nowrap>
                  ...
                  onclick="modalDelete({{$row->id}}, `{{$row->eti_descripcion}}`,`<?php echo $title_estado ?>`,`{{$row->estado}}`);" title="<?php echo $title_estado; ?>">
...
<script>
  ...
  function modalDelete(id, textRow, title, estado) {
    ...
    var text = `¿Esta seguro de <strong> ${title} </strong> de etiquetas: <strong> ${textRow} </strong> ?`;

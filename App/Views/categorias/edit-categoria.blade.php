              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="cat_descripcion" id="cat_descripcion" placeholder="Descripcion" value="{{ $categoria->cat_descripcion }}" >
                  </div>
                </div>
                ...
                <div class="col-12 mb-3">
                  ...
                  <div class="form-group">
                    <div class="input-group mb-2">
                      ...
                      <input data-file-img="images" data-id="preview-images-id" type="file" class="form-control" name="cat_imagen" id="cat_imagen" placeholder="Imagen" accept="image/*">
                    </div>
                  </div>
                </div>

    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header bg-white">
          <i class="fa fa-align-justify"></i> Nuevo Notificacion
        </div>
        <div class="card-body">
          <div class="col-12">

            <form action="{{  route('notificacion-store') }}" method="POST" enctype="multipart/form-data">
              @csrf
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="fecha_envio" id="fecha_envio" placeholder="Fecha Envio">
                  </div>
                </div>

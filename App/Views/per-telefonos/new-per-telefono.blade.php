    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header bg-white">
          <i class="fa fa-align-justify"></i> Nuevo Per Telefono
        </div>
        <div class="card-body">
          <div class="col-12">

            <form action="{{  route('per-telefono-store') }}" method="POST" enctype="multipart/form-data">
              @csrf
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="pt_jerarquia" id="pt_jerarquia" placeholder="Jerarquia">
                  </div>
                </div>

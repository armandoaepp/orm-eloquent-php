        ...
        <div class="card-body">
          <div class="col-12">
            ...
            <form action="{{  route('producto-media-update') }}" method="POST" enctype="multipart/form-data">
              @csrf
              <input type="hidden" class="form-control" name="id" id="id" value="{{ $producto_media->id }}">
              <div class="row">
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="pm_jerarquia" id="pm_jerarquia" placeholder="Jerarquia" value="{{ $producto_media->pm_jerarquia }}" >
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="pm_descripcion" id="pm_descripcion" placeholder="Descripcion" value="{{ $producto_media->pm_descripcion }}" >
                  </div>
                </div>

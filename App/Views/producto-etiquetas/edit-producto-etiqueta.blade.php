  ...
  <ol class="breadcrumb breadcrumb-shape breadcrumb-theme shadow-sm radius-0">
    ...
    <li class="breadcrumb-item" aria-current="page">
      <a href="{{ route('admin-producto-etiquetas') }}" class="">
        <i class="fa fa-align-justify"></i> Producto Etiquetas
      </a>
    </li>
        ...
        <div class="card-body">
          <div class="col-12">
            ...
            <form action="{{  route('producto-etiqueta-update') }}" method="POST" enctype="multipart/form-data">
              @csrf
              <input type="hidden" class="form-control" name="id" id="id" value="{{ $producto_etiqueta->id }}">
              <div class="row">
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <select class="custom-select select2-box" name="etiqueta_id" id="etiqueta_id" placeholder="Etiqueta Id">
                      <option value="" selected disabled hidden>Seleccionar </option> 
                      <option value="text">text</option>
                    </select>
                  </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="pm_estado" id="pm_estado" placeholder="Pm Estado" value="{{ $producto_etiqueta->pm_estado }}" >
                  </div>
                </div>

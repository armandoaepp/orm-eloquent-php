    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header bg-white">
          <i class="fa fa-align-justify"></i> Editar Per Direccion
        </div>
        <div class="card-body">
          <div class="col-12">

            <form action="{{  route('per-direccion-update') }}" method="POST" enctype="multipart/form-data">
              @csrf
              <input type="hidden" class="form-control" name="id" id="id" value="{{ $per_direccion->id }}">
              <div class="row">
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="pd_jerarquia" id="pd_jerarquia" placeholder="Jerarquia" value="{{ $per_direccion->pd_jerarquia }}" >
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="pd_direccion" id="pd_direccion" placeholder="Direccion" value="{{ $per_direccion->pd_direccion }}" >
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="pd_referencia" id="pd_referencia" placeholder="Referencia" value="{{ $per_direccion->pd_referencia }}" >
                  </div>
                </div>

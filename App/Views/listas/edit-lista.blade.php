    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header bg-white">
          <i class="fa fa-align-justify"></i> Editar Lista
        </div>
        <div class="card-body">
          <div class="col-12">

            <form action="{{  route('lista-update') }}" method="POST" enctype="multipart/form-data">
              @csrf
              <input type="hidden" class="form-control" name="id" id="id" value="{{ $data->lista_id }}">
              <div class="row">
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="desc_lista" id="desc_lista" placeholder="Desc Lista" value="{{ $data->desc_lista }}" >
                  </div>
                </div>

                ...
                <td class="text-center">
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                      ...
                      <a class="dropdown-item " href="#" onclick="modalDelete(event,{{$row->id}}, `{{$row->ser_descripcion}}`,`<?php echo $title_estado ?>`,`{{$row->ser_estado}}`);" title="<?php echo $title_estado; ?>" >
                        <i class="far fa-trash-alt"></i> <?php echo $title_estado; ?>
                      </a>
                      <a class="dropdown-item <?php echo $class_disabled; ?>" href="#" onclick="modalPublicar(event, <?php echo $row->id ?>, `<?php echo $row->ser_descripcion ?>` ,`<?php echo $title ?>`, `<?php echo $row->ser_publicar;  ?>`);" >
...
<script>
  ...
  (function ($) {
    function processFormModal(event) {
      ...
      let url_api = "{{ route('servicio-delete') }}";
  ...
  function modalDelete(event, id, textRow, title, estado) {
    ...
    var text = `¿Esta seguro de <strong> ${title} </strong> servicio: <strong> ${textRow} </strong> ?`;
...
<script>
  ...
  (function ($) 
  {
    ...
    function processFormModalPublicar(event) {
      ...
      let url_api_pub = "{{ route('servicio-publish') }}";

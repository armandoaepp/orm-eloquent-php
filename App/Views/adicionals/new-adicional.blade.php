              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="adi_descripcion" id="adi_descripcion" placeholder="Descripcion">
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="adi_precio" id="adi_precio" placeholder="Precio">
                  </div>
                </div>

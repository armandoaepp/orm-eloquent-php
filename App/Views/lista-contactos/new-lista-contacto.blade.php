      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="col-12">
            ...
            <form action="{{  route('lista contacto-save') }}" method="POST" enctype="multipart/form-data">
              @csrf
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="contacto_id" id="contacto_id" placeholder="Contacto Id">
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="lista_id" id="lista_id" placeholder="Lista Id">
                  </div>
                </div>

        ...
        <div class="card-body">
          <div class="col-12">
            ...
            <form action="{{  route('tipo-media-update') }}" method="POST" enctype="multipart/form-data">
              @csrf
              <input type="hidden" class="form-control" name="id" id="id" value="{{ $tipo_media->id }}">
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="tm_descripcion">Descripcion: </label>
                    <input type="text" class="form-control" name="tm_descripcion" id="tm_descripcion" placeholder="Descripcion" value="{{ $tipo_media->tm_descripcion }}" >
                  </div>
                </div>

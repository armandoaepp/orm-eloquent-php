                ...
                <td class="text-center">
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                      <a  class="dropdown-item btn-action" href="#" data-href="{{ route('admin.etiquetas.edit',['id' => $row->id]) }}" onclick="openModalEdit(this);event.preventDefault();" title="Editar etiqueta: {{ $title }}" type="button">
                        <i class="far fa-edit"></i> Editar
                      </a>
                      <a class="dropdown-item btn-action" href="#" data-href="{{ route('admin.etiquetas.destroy') }}" onclick="openModalDestroy(this);event.preventDefault();"  data-id="{{$row->id}}"   title="Borrar etiqueta: {{ $title }}" data-title="{{ $title }}" type="button" >

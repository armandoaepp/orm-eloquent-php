                ...
                <td class="text-center">
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                      <a  class="dropdown-item btn-action" href="#" data-href="{{ route('admin.persona-tipo-vias.edit',['id' => $row->id]) }}" onclick="openModalEdit(this);event.preventDefault();" title="Editar persona_tipo_via: {{ $title }}" type="button">
                        <i class="far fa-edit"></i> Editar
                      </a>
                      <a class="dropdown-item btn-action" href="#" data-href="{{ route('admin.persona-tipo-vias.destroy') }}" onclick="openModalDestroy(this);event.preventDefault();"  data-id="{{$row->id}}"   title="Borrar persona_tipo_via: {{ $title }}" data-title="{{ $title }}" type="button" >

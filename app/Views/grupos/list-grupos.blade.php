...
<div class="container-fluid">
  <div class="row">
    <div class="col-12 mb-3">
      <a href="#" data-reload="list-table" data-href="{{ route('admin.grupos') }}" class="btn btn-outline-secondary btn-sm" type="button">
        <i class="fas fa-list-ul"></i>
        Listar
      </a>
      <a href="#" id="btn-create" data-href="{{ route('admin.grupos.create') }}" class="btn btn-outline-secondary btn-sm" type="button">
...
@section('modal')
  ...
  <x-forms.form-destroy table="Grupo" />  
  <x-forms.form-publish url="{{ route('admin.grupos.publish') }}" /> 
@endsection

...
<div class="container-fluid">
  <div class="row">
    <div class="col-12 mb-3">
      <a href="{{ route('admin.familias') }}" class="btn btn-outline-secondary btn-sm btn-bar" role="button">
        <i class="fas fa-list-ul"></i>
        Listar
      </a>
      <a href="{{ route('admin.familias.create') }}" class="btn btn-outline-secondary btn-sm btn-bar" role="button">
                ...
                <td class="text-center">
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                      <a class="dropdown-item <?php echo $class_disabled; ?>" href="{{ route('admin.familias.edit',['id' => $row->id]) }}" >
                        <i class="far fa-edit"></i> Editar
                      </a>
                      <a class="dropdown-item item-delete" href="#" data-id="{{ $row->id }}" data-descripcion="{{ $row->cod_fam }}" data-title="<?php echo $title_estado ?>" data-estado="{{ $row->estado }}" title="<?php echo $title_estado; ?>" >
                        <i class="far fa-trash-alt"></i> <?php echo $title_estado; ?>
                      </a>
                      <a class="dropdown-item item-publish <?php echo $class_disabled; ?>" href="#" data-id="{{ $row->id }}" data-descripcion="{{ $row->cod_fam }}" data-title="<?php echo $title ?>" data-publish="{{ $row->publicar }}" title="<?php echo $title; ?>" >
...
@section('modal')
  ...
  @include('shared.form-modal-delete', ['url' => route('admin.familias.delete') ])

  @include('shared.form-modal-publicar' , ['url_publish' => route('admin.familias.publish') ])

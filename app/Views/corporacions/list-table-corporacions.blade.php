                ...
                <td class="text-center">
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                      <a  class="dropdown-item btn-action" href="#" data-href="{{ route('admin.corporacions.edit',['id' => $row->id]) }}" onclick="openModalEdit(this);event.preventDefault();" title="Editar corporacion: {{ $title }}" type="button">
                        <i class="far fa-edit"></i> Editar
                      </a>
                      <a class="dropdown-item btn-action" href="#" data-href="{{ route('admin.corporacions.destroy') }}" data-descripcion="{{ $row->ruc }}" onclick="openModalDestroy(this);event.preventDefault();" title="Borrar corporacion: {{ $title }}" data-title="{{ $title }}" >

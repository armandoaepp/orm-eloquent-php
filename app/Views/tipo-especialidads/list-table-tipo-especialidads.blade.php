                ...
                <td class="text-center">
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                      <a  class="dropdown-item btn-action" href="#" data-href="{{ route('admin.tipo-especialidads.edit',['id' => $row->id]) }}" onclick="openModalEdit(this);event.preventDefault();" title="Editar tipo_especialidad: {{ $title }}" type="button">
                        <i class="far fa-edit"></i> Editar
                      </a>
                      <a class="dropdown-item btn-action" href="#" data-href="{{ route('admin.tipo-especialidads.destroy') }}" onclick="openModalDestroy(this);event.preventDefault();"  data-id="{{$row->id}}"   title="Borrar tipo_especialidad: {{ $title }}" data-title="{{ $title }}" type="button" >

                ...
                <td class="text-center">
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                      <a  class="dropdown-item btn-action" href="#" data-href="{{ route('admin.cargos.edit',['id' => $row->id]) }}" onclick="openModalEdit(this);event.preventDefault();" title="Editar cargo: {{ $title }}" type="button">
                        <i class="far fa-edit"></i> Editar
                      </a>
                      <a class="dropdown-item btn-action" href="#" data-href="{{ route('admin.cargos.destroy') }}" data-descripcion="{{ $row->descripcion }}" onclick="openModalDestroy(this);event.preventDefault();" title="Borrar cargo: {{ $title }}" data-title="{{ $title }}" >

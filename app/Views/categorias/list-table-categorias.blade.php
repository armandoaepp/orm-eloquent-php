                ...
                <td class="text-center">
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                      <a  class="dropdown-item btn-action" href="#" data-href="{{ route('admin.categorias.edit',['id' => $row->id]) }}" onclick="openModalEdit(this);event.preventDefault();" title="Editar categoria: {{ $title }}" type="button">
                        <i class="far fa-edit"></i> Editar
                      </a>
                      <a class="dropdown-item btn-action" href="#" data-href="{{ route('admin.categorias.destroy') }}" data-descripcion="{{ $row->familia_id }}" onclick="openModalDestroy(this);event.preventDefault();" title="Borrar categoria: {{ $title }}" data-title="{{ $title }}" >

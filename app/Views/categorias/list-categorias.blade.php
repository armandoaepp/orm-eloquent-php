...
<div class="container-fluid">
  <div class="row">
    <div class="col-12 mb-3">
      <a href="#" data-reload="list-table" data-href="{{ route('admin.categorias') }}" class="btn btn-outline-primary btn-sm" type="button">
        <i class="fas fa-list-ul"></i>
        Listar
      </a>
      <a href="#" id="btn-create" data-href="{{ route('admin.categorias.create') }}" class="btn btn-outline-primary btn-sm" type="button">
...
@section('modal')
  ...
  <x-forms.form-destroy table="Categoria" url="{{ route('admin.categorias.destroy') }}" />  
